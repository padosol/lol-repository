...
public class MatchParticipantChallengesEntity {
    ...
    @Comment("가장 빠른 전설급 아이템 시간")
    private double fastestLegendary;

    @Comment("첫 처치 후 에이스까지 최단 시간")
    private double shortestTimeToAceFromFirstTakedown;

    public static MatchParticipantChallengesEntity of(MatchParticipantEntity matchParticipant, ChallengesDto challengesDto) {
        ...
        return MatchParticipantChallengesEntity.builder()
                .puuid(matchParticipant.getPuuid())
                .matchId(matchParticipant.getMatchId())
                ...
                .earliestBaron(challengesDto.getEarliestBaron())
                ...
                .healFromMapSources(challengesDto.getHealFromMapSources())
                .fastestLegendary(challengesDto.getFastestLegendary())
                .shortestTimeToAceFromFirstTakedown(challengesDto.getShortestTimeToAceFromFirstTakedown())
                .build();
    }
}
