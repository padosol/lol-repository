package lol.mmrtr.lolrepository.domain.service;

import lol.mmrtr.lolrepository.domain.entity.ParticipantFrame;
import lol.mmrtr.lolrepository.domain.entity.TimeLineEvent;
import lol.mmrtr.lolrepository.domain.entity.event.*;
import lol.mmrtr.lolrepository.domain.timeline.repository.EventVictimDamageDealtRepository;
import lol.mmrtr.lolrepository.domain.timeline.repository.EventVictimDamageReceivedRepository;
import lol.mmrtr.lolrepository.domain.timeline.repository.ParticipantFrameRepository;
import lol.mmrtr.lolrepository.domain.timeline.repository.TimeLineEventRepository;
import lol.mmrtr.lolrepository.domain.timeline.repository.event.ItemEventRepository;
import lol.mmrtr.lolrepository.domain.timeline.repository.event.SkillEventRepository;
