...
import com.mmrtr.lolrepository.domain.match.entity.id.ChallengesId;
...
public class Challenges {
        ...
        public static Challenges of(MatchSummoner matchSummoner, ChallengesDto challengesDto) {
                ...
                return Challenges.builder()
                        .matchSummonerId(new MatchSummonerId(
                                matchSummoner.getMatchSummonerId().getPuuid(),
                                matchSummoner.getMatchSummonerId().getMatchId()
                        ))
