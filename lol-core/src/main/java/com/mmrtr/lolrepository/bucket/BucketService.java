package com.mmrtr.lolrepository.bucket;
...
public class BucketService {
    ...
    public enum BucketKey{
        ...
        LEAGUE_V4_BY_QUEUE(30, Duration.ofSeconds(10)),
        LEAGUE_V4_BY_SUMMONER(100, Duration.ofMinutes(1)),
        SUMMONER_V4_BY_PUUID(265, Duration.ofSeconds(10)),
        SUMMONER_V4_BY_ACCOUNT(265, Duration.ofSeconds(10)),
